...
| ----------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| fields                                    | field information                                              | () => [Fields](/docs/api/general/s2-data-config#fields)                                                                                                                                        |                                                                      |
| meta                                      | Field meta information, including field name, formatting, etc. | () => [Meta\[\]](/docs/api/general/s2-data-config#meta)                                                                                                                                        |                                                                      |
...
| sortParams                                | sort configuration                                             | () => [SortParams](/docs/api/general/s2-data-config#sortparams)                                                                                                                                |                                                                      |
| spreadsheet                               | Form example                                                   | () => [SpreadSheet](/docs/api/basic-class/spreadsheet)                                                                                                                                       |                                                                      |
| getFieldMeta                              | Get field metadata information                                 | (field: string, meta?: [Meta\[\]](/docs/api/general/s2-data-config#meta) ) => [Meta](/docs/api/general/s2-data-config#meta)                                                                      |                                                                      |
...
| setDataCfg                                | Set data configuration                                         | `<T extends boolean = false>(dataCfg: T extends true ?` [`S2DataConfig`](/docs/api/general/s2-data-config) `: Partial<`[`S2DataConfig`](/docs/api/general/s2-data-config)`>, reset?: T) => void` | The `reset` parameter needs to be used in `@antv/s2^1.34.0` version |
