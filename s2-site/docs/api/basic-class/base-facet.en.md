...
| cornerBBox                        | corner bounding box                                                                               | [BBox](/api/basic-class/spreadsheet/#bbox)                                                                             |          |
| panelBBox                         | Value area bounding box                                                                           | [BBox](/api/basic-class/spreadsheet/#bbox)                                                                             |          |
...
| addCell                           | add cell                                                                                          | (cell: [BaseCell](/api/basic-class/base-cell) ) => void                                                                |          |
...
| getHiddenColumnsInfo              | Match whether the current node is a hidden node, if so, return the hidden information of the node | (node: [Node](/api/basic-class/node) ) => [HiddenColumnsInfo](/api/basic-class/store#hiddencolumnsinfo) \| `null` | `1.34.1` |
| getCornerNodes                    | Get corner node                                                                                   | () => [Node](/api/basic-class/node) \[]                                                                                | `1.40.0` |
