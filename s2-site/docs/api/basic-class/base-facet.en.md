...
| cornerBBox                        | corner bounding box                                                                               | [BBox](/en/api/basic-class/spreadsheet/#bbox)                                                                             |          |
| panelBBox                         | Value area bounding box                                                                           | [BBox](/en/api/basic-class/spreadsheet/#bbox)                                                                             |          |
| backgroundGroup                   | background area                                                                                   | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| panelGroup                        | Numeric field                                                                                     | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| foregroundGroup                   | foreground area                                                                                   | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| layoutResult                      | layout information                                                                                | [LayoutResult](#layoutresult)                                                                                               |          |
| viewCellWidths                    | Cell width information                                                                            | `number[]`                                                                                                                  |          |
| hScrollBar                        | Value area horizontal scroll bar                                                                  | () => [Group](https://g.antv.antgroup.com/api/basic/group)                                                                      |          |
| hRowScrollBar                     | Line header area horizontal scroll bar                                                            | () => [Group](https://g.antv.antgroup.com/api/basic/group)                                                                      |          |
| vScrollBar                        | Value area vertical scroll bar                                                                    | () => [Group](https://g.antv.antgroup.com/api/basic/group)                                                                      |          |
...
| centerFrame                       | frame                                                                                             | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
...
| scrollBarTheme                    | scroll bar theme                                                                                  | [ScrollBarTheme](/en/api/general/s2-theme/#scrollbartheme)                                                                 |          |
...
| addCell                           | add cell                                                                                          | (cell: [BaseCell](/en/api/basic-class/base-cell) ) => void                                                                |          |
| drawGrid                          | draw grid                                                                                         | () => void                                                                                                                  |          |
| getCanvasSize                     | Get canvas width and height                                                                       | `{width: number, height: number}`                                                                                           |          |
| backgroundGroup                   | background color area group                                                                       | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| foregroundGroup                   | background color area group                                                                       | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| panelGroup                        | Visible range cell area group                                                                     | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| panelScrollGroup                  | Visible range cell scrolling area group                                                           | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenRowGroup                    | Header freeze area group                                                                          | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenColGroup                    | Column header freeze area group                                                                   | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenTrailingRowGroup            | Freezing area group at the bottom of the row header                                               | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenTrailingColGroup            | Freeze area group at the bottom of the column header                                              | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenTopGroup                    | top freeze area group                                                                             | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| frozenBottomGroup                 | Bottom freeze area group                                                                          | [Group](https://g.antv.antgroup.com/api/basic/group)                                                                            |          |
| getHiddenColumnsInfo              | Match whether the current node is a hidden node, if so, return the hidden information of the node | (node: [Node](/en/api/basic-class/node) ) => [HiddenColumnsInfo](/en/api/basic-class/store#hiddencolumnsinfo) \| `null` | `1.34.1` |
| getCornerNodes                    | Get corner node                                                                                   | () => [Node](/en/api/basic-class/node) \[]                                                                                | `1.40.0` |
