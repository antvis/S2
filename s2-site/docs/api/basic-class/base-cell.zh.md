...
| getIconStyle | 获取单元格图标样式 | () => [`IconTheme`](/docs/api/general/s2-theme#icontheme) |
| getStyle | 获取单元格样式 | (name?: string) => [`DefaultCellTheme`](/docs/api/general/s2-theme#defaultcelltheme) |
