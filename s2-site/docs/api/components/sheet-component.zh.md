...
| onRangeSorted | 组内排序结束触发回调事件（暂只支持透视表） | (event: GEvent ) => void; |  |  |
...
| onActionIconHover | 行头操作 icon 悬停事件 | (event: GEvent) => void |  |  |
| onActionIconClick | 行头操作 icon 点击事件 | (event: GEvent) => void |  |  |
| onContextMenu | 右键单元格单击事件 | (data: [TargetCellInfo](#targetcellinfo)) => void |  |  |
| onMouseHover | 表格鼠标悬停事件 | (event: GEvent) => void |  |  |
| onMouseUp | 表格鼠标松开事件 | (event: GEvent) => void |  |  |
...
| rangeSorted | 组内排序结束触发回调事件（暂只支持透视表） | (event: GEvent ) => void; |  |  |
...
| actionIconHover | 行头操作 icon 悬停事件 | (event: GEvent) => void |  |  |
| actionIconClick | 行头操作 icon 点击事件 | (event: GEvent) => void |  |  |
| contextMenu | 右键单元格单击事件 | (data: [TargetCellInfo](#targetcellinfo)) => void |  |  |
| mouseHover | 表格鼠标悬停事件 | (event: GEvent) => void |  |  |
| mouseUp | 表格鼠标松开事件 | (event: GEvent) => void |  |  |
