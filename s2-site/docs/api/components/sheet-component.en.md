...
| partDrillDown | Attributes related to dimension drilldown | [PartDrillDown](/api/components/drill-down) | | |
...
| onRowCellCollapsed | Node expand/collapse event callback| ({ isCollapsed: `boolean`, collapseFields: `Record<string, boolean>`, node: [Node](/api/basic-class/node) ) => void; | | |
...
| onDataCellBrushSelection | Value cell brush selection event | ( dataCells: [DataCell](/api/basic-class/base-cell)[] ) => void | | |
...
| onLayoutAfterCollapseRows | Event callback after collapsing row headers in tree mode | ({collapseFields: `Record<string, boolean>`, meta: [Node](/api/basic-class/node) ) => void; | | |
| onBeforeRender | Event before start of render | () => void; | | |
| onAfterRender | render completed event | () => void; | | |
| onMounted | Table loading complete event, you can get the table instance [details](/manual/advanced/get-instance) | (spreadsheet: [SpreadSheet](/api/basic-class/spreadsheet)) => void; | | |
...
| dataCfg | pivot table data mapping configuration item | [S2DataConfig](/en/api/general/s2-data-config) | | ✓ |
...
| themeCfg | custom table theme style | [ThemeCfg](/en/api/general/s2-theme) | | |
| loading | Controls the loading state of the table | `boolean` | | |
...
| rowCellCollapseTreeRows | Click the row header to collapse and expand the button in the tree structure | (params: {id: `number`; isCollapsed: `boolean`; node: [Node](/api/basic-class/node)}) = > void | | |
| rowCellScroll | row header cell scroll event | ({position: [CellScrollPosition](#cellscrollposition)} ) => void; | | |
| rowCellCollapsed | Node expand/collapse event callback| ({ isCollapsed: `boolean`, collapseFields: `Record<string, boolean>`, node: [Node](/api/basic-class/node) ) => void; | | |
...
| dataCellBrushSelection | Value cell brush selection event | (brushRangeDataCells: ( [DataCell](/api/basic-class/base-cell)[] ) => void | | |
...
| mounted | table loading complete event, you can get the table instance [details](/manual/advanced/get-instance) | (spreadsheet: [SpreadSheet](/api/basic-class/spreadsheet)) => void; | | |
...
| selected | cell selected event | ( cells: ([Cell](/api/basic-class/base-cell)[] ) => void | | |
| reset | interaction state reset event | (event: KeyboardEvent) => void | | |
| linkFieldJump | Link field jump event (cellData: @antv/s2 1.37.0 new) | (data: { key: string; cellData: [Node](/api/basic-class/node); record: [Data](/en/api/general/s2-data-config#data) }) => void | | |
...
| Parameter | Description | Type | Default | Required |
| -- | -- | -- | -- | --- |
| target | interaction object | [S2CellType](/api/basic-class/base-cell) | | |
| event | event | [Event](#) | | |
| viewMeta | current node information | [Node](/api/basic-class/node) | | |
...
Function description: After enabling [Hide Column Header](/manual/advanced/interaction/hide-columns), hide the node information of the column header

| Parameter | Description | Type | Default | Required |
| -- | -- | -- | -- | --- |
| hideColumnNodes | Currently hidden node information | [Node](/api/basic-class/node)[] | | |
| displaySiblingNode | Information about neighboring nodes displayed | { prev:[Node](/api/basic-class/node);next: [Node](/api/basic-class/node) } | | |
...
| id | field id | `string` | | |
| meta | cell node information corresponding to the resize hot zone | [Node](/api/basic-class/node) | | |
