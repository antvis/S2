...
<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/3l%26fv9SHB/Kapture%2525202022-06-06%252520at%25252010.55.24.gif" alt="preview" width="600">

#### custom scroll speed

The `scrollSpeedRatio` can be configured to control the scroll rate, which is divided into two directions:`水平`and`垂直`. The range is `0-1` , and the default is `1` . [View specific examples](/zh/examples/interaction/advanced#scroll-speed-ratio)
...
S2 is a virtual scroll, but it also **simulates** the scrolling behavior of the browser, and the `overscrollBehavior` can be configured to control the non-boundary scrolling behavior. [view example](/zh/examples/interaction/advanced#overscroll-behavior)
...
<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/C5cZoErPi/Kapture%2525202022-06-06%252520at%25252011.33.43.gif" alt="preview" width="600">

* `contain` : After scrolling to the border, the parent container will not be triggered to scroll

<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/38KkNLcWR/Kapture%2525202022-06-06%252520at%25252011.31.55.gif" alt="preview" width="600">
...
<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/8pm8Gr0Qy/437b682d-edbd-4943-a9b7-808b6a3a8461.png" alt="preview" width="600">

<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/JRAt1kb93/Kapture%2525202022-06-06%252520at%25252011.28.43.gif" alt="preview" width="600">
...
<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/POvOCUsoA/919c8477-7a05-4fbf-a026-6d7d86b3188e.png" alt="preview" width="600">
...
<img data-mdast="html" src="https://gw.alipayobjects.com/zos/antfincdn/D9%24skF%24Bl/Kapture%2525202022-06-23%252520at%25252017.08.17.gif" alt="preview" width="600">
...
At the same time: For the `s2-react` and `s2-vue` versions, event mapping is also provided, please refer to the [API documentation](/zh/docs/api/components/sheet-component) for details
...
* [Scroll to the specified cell](/zh/examples/interaction/advanced/#scroll-to-cell)
* [cycle scrolling](/zh/examples/interaction/advanced#scroll-loop)
