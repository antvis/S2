...
我们知道，存储明细数据的 `Meta` 结构一般有三种：扁平数组、图、树，对于表场景查询频率非常高，交叉表本身的展现形式也表达了一种树形结构，因此我们选择了构建树形结构来实现 `Meta`。
...
<img src="https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*_fRFSYS-Vi8AAAAAAAAAAAAAARQnAQ" width="700" />
...
<img src="https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*Ek4uSoOmeL8AAAAAAAAAAAAAARQnAQ" width="300" />

### 表框架渲染时间对比

<img src="https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*NWRaS6ifrJYAAAAAAAAAAAAAARQnAQ" width="900" />
