...
* Data source: [MultiData](/en/api/general/s2-data-config#multidata) configuration item, one cell corresponds to multiple pieces of data, divided into raw data and formatted data
