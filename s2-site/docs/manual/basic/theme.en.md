...
S2 has **4** built-in, out-of-the-box theme configurations and also provides powerful theme customization capabilities. [View API](/api/general/s2-theme)
...
[View details](/manual/advanced/custom/cell-align) or the [full API](/api/general/s2-theme#s2theme).
...
View the [full API](/api/general/s2-theme#s2theme).
...
View the [full API](/api/general/s2-theme#scrollbartheme).
