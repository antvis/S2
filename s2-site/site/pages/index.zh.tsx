...
const IndexPage = () => {
  ...
  const features = [
    {
      icon: 'https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*2Tf4S7CpIGAAAAAAAAAAAAAAARQnAQ',
      title: t('专业多维交叉分析'),
      description: t(
    ...
    {
      icon: 'https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*8OWDSrDXAKoAAAAAAAAAAAAAARQnAQ',
      title: t('组件灵活，高扩展性'),
      description: t(
    ...
    {
      icon: 'https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*hDoIRoVTyZQAAAAAAAAAAAAAARQnAQ',
      title: t('高性能，秒级渲染'),
      description: t(
  ...
  const cases = [
    {
      ...
      link: '#',
      image: 'https://gw.alipayobjects.com/mdn/rms_56cbb2/afts/img/A*fKldRasYZJ8AAAAAAAAAAAAAARQnAQ'
    },
  ];
  ...
  return (
    <>
      ...
      <Banner
        coverImage={ <img width='100%' style={ { marginLeft: '100px', marginTop: '40px' } }
