      ...
      <Tabs
        ...
        items={[
                  ...
                  <Collapse.Panel header="筛选器" key="filter">
                    ...
                    <Space className="filter-container">
                      ...
                      <Switch
                        ...
                        checked={
                          mergedOptions.seriesNumberText === '自定义序号文本'
                        }
                        onChange={(checked) => {
                          updateOptions({
                    ...
                    <Space>
                      <Tooltip title="高亮选中单元格">
                        <Switch
                          ...
                          checked={
                            mergedOptions?.interaction?.selectedCellsSpotlight
                          }
                          onChange={(checked) => {
                            updateOptions({
                              interaction: {
                      ...
                      <Tooltip title="在数值单元格悬停800ms,显示tooltip">
                        <Switch
                          ...
                          checked={
                            mergedOptions?.interaction?.hoverFocus as boolean
                          }
                          onChange={(checked) => {
                            updateOptions({
                              interaction: {
          ...
          },
          {
            key: 'customTree',
            label: '自定义目录树',
            children: <CustomTree ref={s2Ref} onMounted={onSheetMounted} />,
          },
          {
            key: 'customGrid',
            label: '自定义行列头',
            children: <CustomGrid ref={s2Ref} onMounted={onSheetMounted} />,
          },
          {
            key: 'strategy',
            label: '趋势分析表',
          ...
          },
          {
            key: 'editable',
            label: '编辑表',
            children: <EditableSheet ref={s2Ref} onMounted={onSheetMounted} />,
          },
          {
            key: 'mobile',
            label: '移动端表格',
