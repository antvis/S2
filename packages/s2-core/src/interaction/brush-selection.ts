...
import { S2Range } from '@/common/interface';

function getBrushRegion(p1, p2): S2Range {
...
export class BrushSelection extends BaseInteraction {
  ...
  private getCellsInRegion(region: S2Range) {
