...
export class EventController {
  ...
  private resetSheetStyle(event: Event) {
    ...
    const { interceptInteraction } = this.spreadsheet.interaction;
    if (interceptInteraction.has(InterceptInteractionType.BRUSH_SELECTION)) {
      interceptInteraction.delete(InterceptInteractionType.BRUSH_SELECTION);
      return;
    }
    ...
    this.spreadsheet.interaction.interceptInteraction.clear();
  }
